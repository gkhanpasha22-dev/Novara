...
## Коммерческое использование шаблона

Шаблон рассчитан не только на портфолио: из него собирается клиентский сайт за 6–10 часов.
План выхода на доход, прайс, скрипты продаж и производственный чек-лист — в
**[docs/money/PLAN-200K.md](./docs/money/PLAN-200K.md)**.
